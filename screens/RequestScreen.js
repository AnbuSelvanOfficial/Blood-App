...
function RequestScreen({navigation}) {
    ...
    const pressHandler = () => {
        Alert.alert("Your Request will accept by Donor Soon...They will Contact you...")
          }
    ...
    <View style={Styles.inputContainer}>
      ...
      <View style={Styles.inputContainer}>
        ...
        <TextInput
        placeholder='Location (Hospital Name)' 
        placeholderTextColor="grey"
        selectionColor="grey"
        style={Styles.inputText}/>
    ...
    <TouchableOpacity style={Styles.signinButton} onPress={() => pressHandler()}>
      <Text style={Styles.signinButtonText}>Request Blood</Text>
    </TouchableOpacity>
